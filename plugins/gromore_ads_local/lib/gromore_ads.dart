...
class GromoreAds {
  ...
  /// 主动移除开屏广告容器（本地 fork 扩展）。
  /// 修复广告未正常关闭时黑色容器残留盖住主页的问题：进主页前调用，
  /// 无论广告是否成功展示，都会强制移除原生叠加在 decorView 上的开屏容器。
  static Future<bool> destroySplashAd() {
    return _platform.destroySplashAd();
  }
